defmodule KVServer do
  ...
  defp serve(socket) do
    ...
    msg =
      # with will retrieve the value returned by the right-side of <- and match it against
      # the pattern on the left side. If the value matches the pattern, with moves on to
      # the next expression. In case there is no match, the non-matching value is returned.
